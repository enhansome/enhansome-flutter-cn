...
* [Rounded Loading Button](https://github.com/chrisedg87/flutter_rounded_loading_button) ⭐ 362 | 🐛 27 | 🌐 Dart | 📅 2024-06-17 \[127⭐] - 带有加载指示器的按钮，包括成功和错误动画，由[Chris Edgington](https://twitter.com/ChrisTheEdg)创建。
...
* [Flutter Inner Drawer](https://github.com/Dn-a/flutter_inner_drawer) ⭐ 515 | 🐛 39 | 🌐 Dart | 📅 2024-07-10 \[211⭐] - 创建内部抽屉（左/右）的简单方法，您可以在其中输入列表菜单，由[Di Natale Antonino](https://github.com/Dn-a)提供。
...
* [FL Chart](https://github.com/imaNNeoFighT/fl_chart) ⭐ 7,576 | 🐛 407 | 🌐 Dart | 📅 2026-09-01 \[3846⭐] - 在Flutter中绘制出色的图表，由 [Iman Khoshabi](http://www.ikhoshabi.com) 制作。
...
* [Firebase Analytics](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_analytics) ⭐ 9,254 | 🐛 74 | 🌐 Dart | 📅 2026-09-02 - 连接到 Firebase Analytics API。
...
* [Firebase AdMob](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_admob) ⭐ 9,254 | 🐛 74 | 🌐 Dart | 📅 2026-09-02 - 使用 Firebase 进行广告集成。
...
* [Square In-App Payments SDK](https://github.com/square/in-app-payments-flutter-plugin) ⭐ 341 | 🐛 13 | 🌐 Objective-C | 📅 2026-09-04 \[283⭐] - 在应用中嵌入卡片输入表单以生成顾客提供的卡片信息或数字钱包的 Nonce，以进行支付，由 [Square](https://github.com/orgs/square) 制作。
...
* [Local Notifications](https://github.com/MaikuB/flutter_local_notifications) ⭐ 2,661 | 🐛 128 | 🌐 Dart | 📅 2026-08-31 \[1203⭐] - 用于显示本地通知的插件，由 [Michael Bui](https://github.com/MaikuB)提供。
* [Permission Handler](https://github.com/baseflow/flutter-permission-handler) ⭐ 2,172 | 🐛 158 | 🌐 Dart | 📅 2026-09-04<!--stargazers:baseflow/flutter-permission-handler--> - Flutter权限插件，提供跨平台（iOS，Android）API来请求和检查权限，由[Baseflow](https://baseflow.com)。
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ⭐ 1,563 | 🐛 10 | 🌐 Dart | 📅 2026-09-02 \[392⭐] - 本机文件浏览器加载，支持绝对文件路径，由[Miguel Ruivo](https://github.com/miguelpruivo)。
...
* [Moor](https://github.com/simolus3/moor) ⭐ 3,268 | 🐛 209 | 🌐 Dart | 📅 2026-09-04 - Moor 是一个易于使用、反应式、类型安全的 Dart 和 Flutter 持久化库，由 [Simon Binder](https://github.com/simolus3) 开发。
...
* [RiverPod](https://github.com/rrousselGit/river_pod) ⭐ 7,376 | 🐛 160 | 🌐 Dart | 📅 2026-09-03 \[2214⭐] - Provider 的不同实现，由 [Remi Rousselet](https://github.com/rrousselGit) 开发。
...
* [NETCoreSync](https://github.com/aldycool/NETCoreSync) ⭐ 79 | 🐛 1 | 🌐 Dart | 📅 2022-12-08 - 面向多个客户端的集中式数据库同步框架，基于 [Moor](https://github.com/simolus3/moor) ⭐ 3,268 | 🐛 209 | 🌐 Dart | 📅 2026-09-04 库，由 [Aldy J](https://github.com/aldycool) 开发。
...
* [Flame](https://github.com/luanpotter/flame) ⭐ 10,739 | 🐛 86 | 🌐 Dart | 📅 2026-09-03 \[5173⭐] - 极简主义的游戏引擎，由 [Luan Nico](https://github.com/luanpotter)提供。
...
* [AppFlowy](https://github.com/AppFlowy-IO/appflowy) ⭐ 76,260 | 🐛 1,016 | 🌐 Dart | 📅 2026-09-01 \[12156⭐] - 开源的 Notion 替代方案。你对数据和自定义有绝对控制。使用 Flutter 和 Rust 构建，由 [AppFlowy 团队](https://www.appflowy.io/) 开发。
...
* [Flutter Team Samples](https://github.com/flutter/samples) ⭐ 19,256 | 🐛 19 | 🌐 Dart | 📅 2026-09-03 \[8245⭐] - 示例集合（包括地图，json，Material和Cupertino） 由 [Flutter team](https://github.com/orgs/flutter/people)提供。
...
* [GitJournal](https://github.com/GitJournal/GitJournal) ⭐ 4,218 | 🐛 132 | 🌐 Dart | 📅 2026-05-26 \[507⭐] - 在Git Repo中记录数据，由[Vishesh Handa](https://github.com/vHanda)提供。
* [AuthPass](https://github.com/authpass/authpass) ⭐ 2,771 | 🐛 165 | 🌐 Dart | 📅 2026-08-28 \[372⭐] - 与手机和台式机兼容的Keepass密码管理器，由[hpoul](https://github.com/hpoul)提供。
...
* [FVM](https://github.com/leoafarias/fvm) ⭐ 5,510 | 🐛 56 | 🌐 Dart | 📅 2026-09-03 \[2233⭐] - Flutter版本管理：一个简单的命令行工具，用于管理Flutter SDK的版本。
...
* [Fluent UI](https://github.com/bdlukaa/fluent_ui) ⭐ 3,468 | 🐛 46 | 🌐 Dart | 📅 2026-08-29 \[566⭐] - Microsoft的Fluent Design System在Flutter中的实现，由[Bruno D'Luka](https://twitter.com/bdlukaadev)开发。
