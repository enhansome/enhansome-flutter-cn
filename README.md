...
* [FL Chart](https://github.com/imaNNeoFighT/fl_chart) ⭐ 7,577 | 🐛 407 | 🌐 Dart | 📅 2026-09-01 \[3846⭐] - 在Flutter中绘制出色的图表，由 [Iman Khoshabi](http://www.ikhoshabi.com) 制作。
...
* [Get](https://github.com/jonataslaw/get) ⭐ 11,198 | 🐛 1,178 | 🌐 Dart | 📅 2026-06-12 \[1219⭐] - 一个应用于Flutter的高性能状态管理，智能依赖性注入和路由管理的插件，由[Jonny Borges](https://github.com/jonataslaw)。
...
* [Flutter AppAuth](https://github.com/MaikuB/flutter_appauth) ⭐ 308 | 🐛 101 | 🌐 Objective-C | 📅 2026-08-31 \[120⭐] - 提供围绕AppAuth iOS和Android SDK的包装的插件，由[Michael Bui](https://github.com/MaikuB)提供。
...
* [TeX](https://github.com/shah-xad/flutter_tex) ⭐ 305 | 🐛 61 | 🌐 Dart | 📅 2026-09-03 \[186⭐] - 使用完整的HTML和JavaScript支持来渲染数学方程式，由 [Shahzad Akram](https://github.com/shah-xad) 制作。
...
* [Firebase Analytics](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_analytics) ⭐ 9,253 | 🐛 72 | 🌐 Dart | 📅 2026-09-02 - 连接到 Firebase Analytics API。
...
* [WebRTC](https://github.com/cloudwebrtc/flutter-webrtc) ⭐ 4,485 | 🐛 694 | 🌐 C++ | 📅 2026-09-03 \[2747⭐] - iOS/Android 的 WebRTC 插件，由 [CloudWebRtc](https://github.com/cloudwebrtc) 制作。
* [Chewie](https://github.com/brianegan/chewie) ⭐ 2,063 | 🐛 444 | 🌐 Dart | 📅 2026-09-02 \[1353⭐] - 提供对视频播放的低级访问，由 [Brian Egan](https://github.com/brianegan) 制作。
...
* [Firebase AdMob](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_admob) ⭐ 9,253 | 🐛 72 | 🌐 Dart | 📅 2026-09-02 - 使用 Firebase 进行广告集成。
...
* [Square In-App Payments SDK](https://github.com/square/in-app-payments-flutter-plugin) ⭐ 341 | 🐛 14 | 🌐 Objective-C | 📅 2026-09-03 \[283⭐] - 在应用中嵌入卡片输入表单以生成顾客提供的卡片信息或数字钱包的 Nonce，以进行支付，由 [Square](https://github.com/orgs/square) 制作。
...
* [Local Notifications](https://github.com/MaikuB/flutter_local_notifications) ⭐ 2,662 | 🐛 127 | 🌐 Dart | 📅 2026-08-31 \[1203⭐] - 用于显示本地通知的插件，由 [Michael Bui](https://github.com/MaikuB)提供。
* [Permission Handler](https://github.com/baseflow/flutter-permission-handler) ⭐ 2,172 | 🐛 157 | 🌐 Dart | 📅 2026-08-11<!--stargazers:baseflow/flutter-permission-handler--> - Flutter权限插件，提供跨平台（iOS，Android）API来请求和检查权限，由[Baseflow](https://baseflow.com)。
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ⭐ 1,562 | 🐛 10 | 🌐 Dart | 📅 2026-09-02 \[392⭐] - 本机文件浏览器加载，支持绝对文件路径，由[Miguel Ruivo](https://github.com/miguelpruivo)。
...
* [Reactive Ble](https://github.com/PhilipsHue/flutter_reactive_ble) ⭐ 735 | 🐛 157 | 🌐 Dart | 📅 2026-08-24 \[84⭐] - 处理多个设备的BLE操作，由[Philips Hue](https://github.com/PhilipsHue)。
...
* [Moor](https://github.com/simolus3/moor) ⭐ 3,268 | 🐛 209 | 🌐 Dart | 📅 2026-09-02 - Moor 是一个易于使用、反应式、类型安全的 Dart 和 Flutter 持久化库，由 [Simon Binder](https://github.com/simolus3) 开发。
...
* [OneSignal](https://github.com/OneSignal/OneSignal-Flutter-SDK) ⭐ 650 | 🐛 9 | 🌐 Dart | 📅 2026-09-03 \[497⭐] - 推送通知服务，由 [OneSignal](https://github.com/OneSignal) 开发。
...
* [Bloc](https://github.com/felangel/bloc) ⭐ 12,481 | 🐛 86 | 🌐 Dart | 📅 2026-09-03 \[8181⭐] - 一套帮助实现 BLoC 设计模式的包集合，由 [Felix Angelov](https://github.com/felangel) 开发。
* [GetX](https://github.com/jonataslaw/getx) ⭐ 11,198 | 🐛 1,178 | 🌐 Dart | 📅 2026-06-12 <!--jonataslaw/getx--> - 无需上下文的状态管理和导航，由 [Jonny Borges](https://github.com/jonataslaw) 开发。
* [RiverPod](https://github.com/rrousselGit/river_pod) ⭐ 7,376 | 🐛 160 | 🌐 Dart | 📅 2026-09-02 \[2214⭐] - Provider 的不同实现，由 [Remi Rousselet](https://github.com/rrousselGit) 开发。
...
* [Redux](https://github.com/brianegan/flutter_redux) ⭐ 1,643 | 🐛 18 | 🌐 Dart | 📅 2023-04-06 \[1522⭐] - 与 [redux.dart](https://github.com/johnpryan/redux.dart) ⭐ 519 | 🐛 10 | 🌐 Dart | 📅 2023-03-09 配合使用的工具，可以轻松使用 Redux Store 构建 Widgets。
...
* [Graphql](https://github.com/zino-app/graphql-flutter) ⭐ 3,271 | 🐛 164 | 🌐 Dart | 📅 2026-07-28 \[2796⭐] - GraphQL 规范的实现，由 [Zino App B.V.](https://github.com/zino-app) 开发。
...
* [NETCoreSync](https://github.com/aldycool/NETCoreSync) ⭐ 79 | 🐛 1 | 🌐 Dart | 📅 2022-12-08 - 面向多个客户端的集中式数据库同步框架，基于 [Moor](https://github.com/simolus3/moor) ⭐ 3,268 | 🐛 209 | 🌐 Dart | 📅 2026-09-02 库，由 [Aldy J](https://github.com/aldycool) 开发。

### 动画

* [SpinKit](https://github.com/jogboms/flutter_spinkit) ⭐ 3,145 | 🐛 16 | 🌐 Dart | 📅 2026-06-22 \[2405⭐] - 由 [Jeremiah Ogbomo](https://twitter.com/jogboms) 开发的动画加载指示器。
...
* [Flame](https://github.com/luanpotter/flame) ⭐ 10,739 | 🐛 84 | 🌐 Dart | 📅 2026-09-02 \[5173⭐] - 极简主义的游戏引擎，由 [Luan Nico](https://github.com/luanpotter)提供。
...
* [Awesome Flame](https://github.com/flame-engine/awesome-flame) ⭐ 1,381 | 🐛 0 | 📅 2026-08-31<!--stargazers:flame-engine/awesome-flame--> - Flame 游戏引擎的精选列表，包含最佳 Flame 游戏、项目、库、工具、教程、文章等，由 [Flame Engine](https://github.com/flame-engine) 维护。

## 开源App

### 高级

* [AppFlowy](https://github.com/AppFlowy-IO/appflowy) ⭐ 76,233 | 🐛 1,016 | 🌐 Dart | 📅 2026-09-01 \[12156⭐] - 开源的 Notion 替代方案。你对数据和自定义有绝对控制。使用 Flutter 和 Rust 构建，由 [AppFlowy 团队](https://www.appflowy.io/) 开发。
...
* [Flutter Team Samples](https://github.com/flutter/samples) ⭐ 19,255 | 🐛 19 | 🌐 Dart | 📅 2026-09-02 \[8245⭐] - 示例集合（包括地图，json，Material和Cupertino） 由 [Flutter team](https://github.com/orgs/flutter/people)提供。
...
* [GitJournal](https://github.com/GitJournal/GitJournal) ⭐ 4,217 | 🐛 132 | 🌐 Dart | 📅 2026-05-26 \[507⭐] - 在Git Repo中记录数据，由[Vishesh Handa](https://github.com/vHanda)提供。
* [AuthPass](https://github.com/authpass/authpass) ⭐ 2,770 | 🐛 165 | 🌐 Dart | 📅 2026-08-28 \[372⭐] - 与手机和台式机兼容的Keepass密码管理器，由[hpoul](https://github.com/hpoul)提供。
...
* [Lime](https://github.com/fablue/lime-flutter) ⭐ 372 | 🐛 12 | 🌐 Dart | 📅 2018-05-31 \[335⭐] - 使用Flutter开发的Lime客户端。
...
* [FVM](https://github.com/leoafarias/fvm) ⭐ 5,510 | 🐛 56 | 🌐 Dart | 📅 2026-08-27 \[2233⭐] - Flutter版本管理：一个简单的命令行工具，用于管理Flutter SDK的版本。
* [Very Good Cli](https://github.com/VeryGoodOpenSource/very_good_cli) ⭐ 2,414 | 🐛 21 | 🌐 Dart | 📅 2026-09-03 \[1135⭐] - Dart的非常好的命令行界面工具，由 [Very Good Ventures](https://github.com/VeryGoodOpenSource) 创建。
...
* [Flutter Flavorizr](https://github.com/AngeloAvv/flutter_flavorizr) ⭐ 570 | 🐛 36 | 🌐 Dart | 📅 2026-09-02 \[160⭐] - CLI实用工具，可在不到3分钟的时间内轻松为Android和iOS生成不同的应用程序风格，由 [Angelo Cassano](https://github.com/AngeloAvv) 创建。
...
* [Golang Desktop Embedder](https://github.com/go-flutter-desktop/go-flutter) ⭐ 5,931 | 🐛 65 | 🌐 Go | 📅 2026-09-03 \[5083⭐] - Golang桌面应用的Flutter嵌入器，由[Pierre Champion](https://github.com/pchampio)开发。
* [Fluent UI](https://github.com/bdlukaa/fluent_ui) ⭐ 3,467 | 🐛 46 | 🌐 Dart | 📅 2026-08-29 \[566⭐] - Microsoft的Fluent Design System在Flutter中的实现，由[Bruno D'Luka](https://twitter.com/bdlukaadev)开发。
...
* [Raspberry Pi Embedder](https://github.com/ardera/flutter-pi) ⭐ 1,989 | 🐛 125 | 🌐 C | 📅 2026-01-31 \[747⭐] - 适用于树莓派的轻量级嵌入器，由[Hannes Winkler](https://github.com/ardera)开发。
...
* [Ubuntu Yaru](https://github.com/ubuntu/yaru.dart) ⭐ 392 | 🐛 58 | 🌐 Dart | 📅 2026-07-22 \[134⭐] - Ubuntu桌面的独特外观和风格，由[Ubuntu](https://github.com/ubuntu)开发。
