...
* [Get](https://github.com/jonataslaw/get) ⭐ 11,198 | 🐛 1,177 | 🌐 Dart | 📅 2026-06-12 \[1219⭐] - 一个应用于Flutter的高性能状态管理，智能依赖性注入和路由管理的插件，由[Jonny Borges](https://github.com/jonataslaw)。
...
* [Firebase Analytics](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_analytics) ⭐ 9,254 | 🐛 76 | 🌐 Dart | 📅 2026-09-02 - 连接到 Firebase Analytics API。
...
* [Firebase AdMob](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_admob) ⭐ 9,254 | 🐛 76 | 🌐 Dart | 📅 2026-09-02 - 使用 Firebase 进行广告集成。
...
* [Permission Handler](https://github.com/baseflow/flutter-permission-handler) ⭐ 2,173 | 🐛 155 | 🌐 Dart | 📅 2026-09-04<!--stargazers:baseflow/flutter-permission-handler--> - Flutter权限插件，提供跨平台（iOS，Android）API来请求和检查权限，由[Baseflow](https://baseflow.com)。
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ⭐ 1,564 | 🐛 10 | 🌐 Dart | 📅 2026-09-02 \[392⭐] - 本机文件浏览器加载，支持绝对文件路径，由[Miguel Ruivo](https://github.com/miguelpruivo)。
...
* [GetX](https://github.com/jonataslaw/getx) ⭐ 11,198 | 🐛 1,177 | 🌐 Dart | 📅 2026-06-12 <!--jonataslaw/getx--> - 无需上下文的状态管理和导航，由 [Jonny Borges](https://github.com/jonataslaw) 开发。
...
* [AppFlowy](https://github.com/AppFlowy-IO/appflowy) ⭐ 76,308 | 🐛 1,017 | 🌐 Dart | 📅 2026-09-01 \[12156⭐] - 开源的 Notion 替代方案。你对数据和自定义有绝对控制。使用 Flutter 和 Rust 构建，由 [AppFlowy 团队](https://www.appflowy.io/) 开发。
...
* [FVM](https://github.com/leoafarias/fvm) ⭐ 5,511 | 🐛 47 | 🌐 Dart | 📅 2026-09-04 \[2233⭐] - Flutter版本管理：一个简单的命令行工具，用于管理Flutter SDK的版本。
