...
* [Sticky Infinite List](https://github.com/TatsuUkraine/flutter_sticky_infinite_list) ⭐ 340 | 🐛 2 | 🌐 Dart | 📅 2026-09-15 \[128⭐] - 带有粘性标题的高度可配置的多向无限列表，由[TatsuUkraine](https://github.com/TatsuUkraine)提供。
...
* [Bottom Navy Bar](https://github.com/pedromassango/bottom_navy_bar) ⭐ 1,095 | 🐛 23 | 🌐 Dart | 📅 2024-12-14 \[550⭐] - 美丽多彩的动画底部导航栏，由[Pedro Massango](https://github.com/pedromassango)提供。
* [Fancy Bottom Navigation](https://github.com/tunitowen/fancy_bottom_navigation) ⭐ 841 | 🐛 43 | 🌐 Dart | 📅 2023-12-01 \[404⭐] - 动画底部导航，由[Tony Owen](https://github.com/tunitowen)提供。
...
* [Titled Navigation Bar](https://github.com/pedromassango/titled_navigation_bar) ⭐ 377 | 🐛 4 | 🌐 Dart | 📅 2021-11-30 \[184⭐] - 动画底部导航栏，可在图标和标题之间切换，由[Pedro Massango](http://github.com/pedromassango)提供。
...
* [Peek & Pop](https://github.com/aliyigitbireroglu/flutter-peek-and-pop) ⭐ 237 | 🐛 4 | 🌐 Dart | 📅 2020-10-16 \[138⭐] - 基于iOS功能的Peek＆Pop实现，由[Ali Yigit Bireroglu](https://github.com/aliyigitbireroglu)提供。
...
* [波浪效果](https://github.com/i-protoss/wave) ⭐ 1,126 | 🐛 22 | 🌐 Dart | 📅 2026-08-17 \[742⭐] - 显示带有自定义颜色、持续时间、浮动和模糊效果的波浪效果，由[RockerFlower](https://github.com/RockerFlower)创建。
...
* [缓存网络图片](https://github.com/renefloor/flutter_cached_network_image) ⭐ 2,590 | 🐛 327 | 🌐 Dart | 📅 2026-09-24 \[1911⭐] - 显示来自互联网的图片并将它们保存在缓存目录中。
...
* [Get](https://github.com/jonataslaw/get) ⭐ 11,197 | 🐛 1,184 | 🌐 Dart | 📅 2026-06-12 \[1219⭐] - 一个应用于Flutter的高性能状态管理，智能依赖性注入和路由管理的插件，由[Jonny Borges](https://github.com/jonataslaw)。
...
* [AutoSizeText](https://github.com/leisim/auto_size_text) ⭐ 2,134 | 🐛 94 | 🌐 Dart | 📅 2023-12-07 \[1496⭐] - 自动调整文本大小，使其完美适应边界，由 [Simon Leier](https://github.com/leisim) 制作。
...
* [Firebase Analytics](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_analytics) ⭐ 9,260 | 🐛 81 | 🌐 Dart | 📅 2026-09-24 - 连接到 Firebase Analytics API。
...
* [Flutter Sound](https://github.com/dooboolab/flutter_sound) ⭐ 942 | 🐛 363 | 🌐 Dart | 📅 2025-11-27 \[666⭐] - 一手掌握的 Flutter 音频录制和播放器，由 [dooboolab](https://github.com/dooboolab) 制作。
...
* [Audio Recorder](https://github.com/ZaraclaJ/audio_recorder) ⭐ 183 | 🐛 35 | 🌐 Java | 📅 2022-04-25 \[169⭐] - 录制音频并将其存储在本地，由 [Jordan Alcaraz](https://twitter.com/jordanalcrz) 制作。
...
* [WebRTC](https://github.com/cloudwebrtc/flutter-webrtc) ⭐ 4,491 | 🐛 713 | 🌐 C++ | 📅 2026-09-22 \[2747⭐] - iOS/Android 的 WebRTC 插件，由 [CloudWebRtc](https://github.com/cloudwebrtc) 制作。
...
* [CamerAwesome](https://github.com/Apparence-io/camera_awesome) ⭐ 1,216 | 🐛 207 | 🌐 Dart | 📅 2026-04-08 \[295⭐] - 社区相机插件改版，由 [Apparence.io studio](https://apparence.io) 制作。
...
* [Streaming Shared Preferences](https://github.com/roughike/streaming_shared_preferences) ⭐ 249 | 🐛 7 | 🌐 Dart | 📅 2022-03-02 - 基于流的键值存储，通过流实现共享首选项，由 [Iiro Krankka](https://github.com/roughike) 制作。

### 赚钱

* [Firebase AdMob](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_admob) ⭐ 9,260 | 🐛 81 | 🌐 Dart | 📅 2026-09-24 - 使用 Firebase 进行广告集成。
...
* [Local Notifications](https://github.com/MaikuB/flutter_local_notifications) ⭐ 2,666 | 🐛 129 | 🌐 Dart | 📅 2026-09-24 \[1203⭐] - 用于显示本地通知的插件，由 [Michael Bui](https://github.com/MaikuB)提供。
...
* [Geolocator](https://github.com/baseflow/flutter-geolocator) ⭐ 1,337 | 🐛 164 | 🌐 Dart | 📅 2026-08-21<!--stargazers:baseflow/flutter-geolocator--> - Flutter地理位置插件，可轻松访问特定于平台的位置服务，由[Baseflow](https://baseflow.com)。
...
* [Reactive Ble](https://github.com/PhilipsHue/flutter_reactive_ble) ⭐ 737 | 🐛 161 | 🌐 Dart | 📅 2026-08-24 \[84⭐] - 处理多个设备的BLE操作，由[Philips Hue](https://github.com/PhilipsHue)。
...
* [OneSignal](https://github.com/OneSignal/OneSignal-Flutter-SDK) ⭐ 651 | 🐛 11 | 🌐 Dart | 📅 2026-09-23 \[497⭐] - 推送通知服务，由 [OneSignal](https://github.com/OneSignal) 开发。
...
* [GetX](https://github.com/jonataslaw/getx) ⭐ 11,197 | 🐛 1,184 | 🌐 Dart | 📅 2026-06-12 <!--jonataslaw/getx--> - 无需上下文的状态管理和导航，由 [Jonny Borges](https://github.com/jonataslaw) 开发。
* [RiverPod](https://github.com/rrousselGit/river_pod) ⭐ 7,389 | 🐛 160 | 🌐 Dart | 📅 2026-09-22 \[2214⭐] - Provider 的不同实现，由 [Remi Rousselet](https://github.com/rrousselGit) 开发。
...
* [styled\_widget](https://github.com/ReinBentdal/styled_widget) ⭐ 1,336 | 🐛 21 | 🌐 Dart | 📅 2023-09-14 \[671⭐] - 通过使用方法定义小部件来简化小部件树结构，由[Rein Gundersen Bentdal](https://github.com/ReinBentdal)。
...
* [Flame](https://github.com/luanpotter/flame) ⭐ 10,766 | 🐛 84 | 🌐 Dart | 📅 2026-09-24 \[5173⭐] - 极简主义的游戏引擎，由 [Luan Nico](https://github.com/luanpotter)提供。
...
* [Awesome Flame](https://github.com/flame-engine/awesome-flame) ⭐ 1,385 | 🐛 0 | 📅 2026-08-31<!--stargazers:flame-engine/awesome-flame--> - Flame 游戏引擎的精选列表，包含最佳 Flame 游戏、项目、库、工具、教程、文章等，由 [Flame Engine](https://github.com/flame-engine) 维护。

## 开源App

### 高级

* [AppFlowy](https://github.com/AppFlowy-IO/appflowy) ⭐ 76,912 | 🐛 1,028 | 🌐 Dart | 📅 2026-09-22 \[12156⭐] - 开源的 Notion 替代方案。你对数据和自定义有绝对控制。使用 Flutter 和 Rust 构建，由 [AppFlowy 团队](https://www.appflowy.io/) 开发。
...
* [GitJournal](https://github.com/GitJournal/GitJournal) ⭐ 4,229 | 🐛 132 | 🌐 Dart | 📅 2026-05-26 \[507⭐] - 在Git Repo中记录数据，由[Vishesh Handa](https://github.com/vHanda)提供。
...
* [FVM](https://github.com/leoafarias/fvm) ⭐ 5,525 | 🐛 39 | 🌐 Dart | 📅 2026-09-21 \[2233⭐] - Flutter版本管理：一个简单的命令行工具，用于管理Flutter SDK的版本。
* [Very Good Cli](https://github.com/VeryGoodOpenSource/very_good_cli) ⭐ 2,422 | 🐛 10 | 🌐 Dart | 📅 2026-09-21 \[1135⭐] - Dart的非常好的命令行界面工具，由 [Very Good Ventures](https://github.com/VeryGoodOpenSource) 创建。
...
* [Golang Desktop Embedder](https://github.com/go-flutter-desktop/go-flutter) ⭐ 5,932 | 🐛 65 | 🌐 Go | 📅 2026-09-08 \[5083⭐] - Golang桌面应用的Flutter嵌入器，由[Pierre Champion](https://github.com/pchampio)开发。
...
* [Raspberry Pi Embedder](https://github.com/ardera/flutter-pi) ⭐ 1,999 | 🐛 127 | 🌐 C | 📅 2026-09-17 \[747⭐] - 适用于树莓派的轻量级嵌入器，由[Hannes Winkler](https://github.com/ardera)开发。
...
* [Ubuntu Yaru](https://github.com/ubuntu/yaru.dart) ⭐ 395 | 🐛 60 | 🌐 Dart | 📅 2026-07-22 \[134⭐] - Ubuntu桌面的独特外观和风格，由[Ubuntu](https://github.com/ubuntu)开发。
