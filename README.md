...
* [Tinder Cards](https://github.com/Ivaskuu/tinder_cards) ⭐ 979 | 🐛 8 | 🌐 Dart | 📅 2020-02-05 \[646⭐] - 类似Tinder的卡片滑动效果，由[Ivascu Adrian](https://github.com/Ivaskuu)创建。
...
* [Rounded Loading Button](https://github.com/chrisedg87/flutter_rounded_loading_button) ⭐ 362 | 🐛 26 | 🌐 Dart | 📅 2024-06-17 \[127⭐] - 带有加载指示器的按钮，包括成功和错误动画，由[Chris Edgington](https://twitter.com/ChrisTheEdg)创建。
...
* [Sticky Infinite List](https://github.com/TatsuUkraine/flutter_sticky_infinite_list) ⭐ 339 | 🐛 2 | 🌐 Dart | 📅 2026-09-15 \[128⭐] - 带有粘性标题的高度可配置的多向无限列表，由[TatsuUkraine](https://github.com/TatsuUkraine)提供。
...
* [Rubber Bottom Sheet](https://github.com/mcrovero/rubber) ⭐ 563 | 🐛 21 | 🌐 Dart | 📅 2026-09-13 \[298⭐] - 弹性材料设计的底部表单，由[Mattia Crovero](https://github.com/mcrovero)提供。
...
* [展示视图](https://github.com/simformsolutions/flutter_showcaseview) ⭐ 1,933 | 🐛 11 | 🌐 Dart | 📅 2026-09-10 \[687⭐] - 在iOS和Android上展示应用程序功能的方式，由[Simform](https://github.com/simformsolutions)开发。
...
* [视差效果](https://github.com/FlutterRocks/page-transformer) ⭐ 877 | 🐛 9 | 🌐 Dart | 📅 2020-02-10 \[735⭐] - 由[Iiro Krankka](https://github.com/roughike)创建的ViewPager。
...
* [表格日历](https://github.com/aleksanderwozniak/table_calendar) ⭐ 1,961 | 🐛 125 | 🌐 Dart | 📅 2026-08-09 \[1167⭐] - 由 [Aleksander Woźniak](https://github.com/aleksanderwozniak) 制作的整洁组织的表格日历，具有垂直自动调整大小的功能。
* [日历轮播小部件](https://github.com/dooboolab/flutter_calendar_carousel) ⭐ 860 | 🐛 2 | 🌐 Dart | 📅 2026-09-15 <!-- stargazers:dooboolab/flutter_calendar_carousel--> - 由 [dooboolab](https://github.com/dooboolab/flutter_calendar_carousel) ⭐ 860 | 🐛 2 | 🌐 Dart | 📅 2026-09-15 制作的日历轮播小部件。
...
* [Flutter登录](https://github.com/NearHuscarl/flutter_login) ⭐ 1,588 | 🐛 109 | 🌐 Dart | 📅 2026-08-10 - 具有平滑动画效果的登录小部件，从开始到结束都很流畅，由 [NearHuscarl](https://github.com/NearHuscarl) 制作。
...
* [动态小部件](https://github.com/dengyin2000/dynamic_widget) ⭐ 1,650 | 🐛 51 | 🌐 Dart | 📅 2025-06-25 \[1100⭐] - 使用JSON构建动态用户界面，JSON格式与Flutter小部件代码非常相似，由 [Denny Deng](https://github.com/dengyin2000) 制作。

### 图片

* [缓存网络图片](https://github.com/renefloor/flutter_cached_network_image) ⭐ 2,589 | 🐛 333 | 🌐 Dart | 📅 2026-09-15 \[1911⭐] - 显示来自互联网的图片并将它们保存在缓存目录中。
...
* [SVG](https://github.com/dnfield/flutter_svg) ⭐ 1,690 | 🐛 247 | 🌐 Dart | 📅 2024-11-01 \[1270⭐] - SVG解析、渲染和小部件库，由 [Dan Field](https://github.com/dnfield) 制作。
...
* [FL Chart](https://github.com/imaNNeoFighT/fl_chart) ⭐ 7,577 | 🐛 409 | 🌐 Dart | 📅 2026-09-01 \[3846⭐] - 在Flutter中绘制出色的图表，由 [Iman Khoshabi](http://www.ikhoshabi.com) 制作。
...
* [环形图](https://github.com/xqwzts/flutter_circular_chart) ⭐ 402 | 🐛 21 | 🌐 Dart | 📅 2024-06-13 \[355⭐] - 由 [Victor Choueiri](https://github.com/xqwzts) 制作的动画径向和饼图。
...
* [Get](https://github.com/jonataslaw/get) ⭐ 11,198 | 🐛 1,185 | 🌐 Dart | 📅 2026-06-12 \[1219⭐] - 一个应用于Flutter的高性能状态管理，智能依赖性注入和路由管理的插件，由[Jonny Borges](https://github.com/jonataslaw)。
...
* [Login](https://github.com/AppleEducate/flutter_login) ⭐ 708 | 🐛 13 | 🌐 Dart | 📅 2021-03-31 \[545⭐] - 自持Face ID, Touch ID, 和 指纹识别验证的Flutter库，由[Rody Davis](http://appleeducate.com)提供。
...
* [Firebase Analytics](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_analytics) ⭐ 9,251 | 🐛 74 | 🌐 Dart | 📅 2026-09-16 - 连接到 Firebase Analytics API。
...
* [WebRTC](https://github.com/cloudwebrtc/flutter-webrtc) ⭐ 4,489 | 🐛 703 | 🌐 C++ | 📅 2026-09-17 \[2747⭐] - iOS/Android 的 WebRTC 插件，由 [CloudWebRtc](https://github.com/cloudwebrtc) 制作。
* [Chewie](https://github.com/brianegan/chewie) ⭐ 2,065 | 🐛 430 | 🌐 Dart | 📅 2026-09-16 \[1353⭐] - 提供对视频播放的低级访问，由 [Brian Egan](https://github.com/brianegan) 制作。
...
* [Secure Storage](https://github.com/mogol/flutter_secure_storage) ⭐ 1,282 | 🐛 0 | 🌐 C++ | 📅 2026-09-16 \[490⭐] - 提供钥匙串和密钥库存储，由 [German Saprykin](https://github.com/mogol)提供。
...
* [Firebase AdMob](https://github.com/FirebaseExtended/flutterfire/tree/master/packages/firebase_admob) ⭐ 9,251 | 🐛 74 | 🌐 Dart | 📅 2026-09-16 - 使用 Firebase 进行广告集成。
...
* [Square In-App Payments SDK](https://github.com/square/in-app-payments-flutter-plugin) ⭐ 341 | 🐛 12 | 🌐 Objective-C | 📅 2026-09-16 \[283⭐] - 在应用中嵌入卡片输入表单以生成顾客提供的卡片信息或数字钱包的 Nonce，以进行支付，由 [Square](https://github.com/orgs/square) 制作。
...
* [Flutter 示例](https://github.com/diegoveloper/flutter-samples) ⭐ 3,207 | 🐛 3 | 🌐 Dart | 📅 2025-11-02 \[2464⭐] - 一系列优秀的 Flutter 示例，由 [Diego Velásquez](https://github.com/diegoveloper) 制作。
...
* [ActingWeb First\_App](https://github.com/gregertw/actingweb_firstapp) ⭐ 520 | 🐛 5 | 🌐 Dart | 📅 2025-03-31 \[285⭐] - 初学者应用程序，包含用于团队开发的生产级应用程序的基本元素，由 [Greger Wedel](https://github.com/gregertw) 制作。
...
* [m2gen](https://github.com/BayesWitnesses/m2cgen) ⭐ 3,003 | 🐛 62 | 🌐 Python | 📅 2024-08-03 \[1667⭐] - CLI工具可将ML模型转换为本地Dart代码，由[BayesWitnesses](https://github.com/BayesWitnesses)。
...
* [Local Notifications](https://github.com/MaikuB/flutter_local_notifications) ⭐ 2,664 | 🐛 127 | 🌐 Dart | 📅 2026-09-17 \[1203⭐] - 用于显示本地通知的插件，由 [Michael Bui](https://github.com/MaikuB)提供。
* [Permission Handler](https://github.com/baseflow/flutter-permission-handler) ⭐ 2,172 | 🐛 160 | 🌐 Dart | 📅 2026-09-04<!--stargazers:baseflow/flutter-permission-handler--> - Flutter权限插件，提供跨平台（iOS，Android）API来请求和检查权限，由[Baseflow](https://baseflow.com)。
* [File Picker](https://github.com/miguelpruivo/plugins_flutter_file_picker) ⭐ 1,566 | 🐛 11 | 🌐 Dart | 📅 2026-09-15 \[392⭐] - 本机文件浏览器加载，支持绝对文件路径，由[Miguel Ruivo](https://github.com/miguelpruivo)。
* [WebView](https://github.com/dart-flitter/flutter_webview_plugin) ⭐ 1,493 | 🐛 551 | 🌐 Java | 📅 2024-03-19 \[1232⭐] - 一个WebView插件， 由[Hadrien Lejard](https://twitter.com/HadrienLejard)提供。
* [Geolocator](https://github.com/baseflow/flutter-geolocator) ⭐ 1,335 | 🐛 160 | 🌐 Dart | 📅 2026-08-21<!--stargazers:baseflow/flutter-geolocator--> - Flutter地理位置插件，可轻松访问特定于平台的位置服务，由[Baseflow](https://baseflow.com)。
...
* [UDID](https://github.com/GigaDroid/flutter_udid) ⭐ 285 | 🐛 2 | 🌐 C++ | 📅 2026-07-14 \[135⭐] - 用于在Android/iOS设备上获取一个持久的 UDID，即使重新安装App，由  [Leon Kukuk](https://kukuk.me)提供。
...
* [Reactive Ble](https://github.com/PhilipsHue/flutter_reactive_ble) ⭐ 737 | 🐛 159 | 🌐 Dart | 📅 2026-08-24 \[84⭐] - 处理多个设备的BLE操作，由[Philips Hue](https://github.com/PhilipsHue)。
...
* [Moor](https://github.com/simolus3/moor) ⭐ 3,276 | 🐛 208 | 🌐 Dart | 📅 2026-09-16 - Moor 是一个易于使用、反应式、类型安全的 Dart 和 Flutter 持久化库，由 [Simon Binder](https://github.com/simolus3) 开发。
* [Sqflite](https://github.com/tekartik/sqflite) ⭐ 3,019 | 🐛 8 | 🌐 Dart | 📅 2026-09-15 \[2289⭐] - SQLite Flutter 插件，由 [Alexandre Roux](https://www.linkedin.com/in/alextekartik/) 开发。

### 服务

* [OneSignal](https://github.com/OneSignal/OneSignal-Flutter-SDK) ⭐ 650 | 🐛 8 | 🌐 Dart | 📅 2026-09-09 \[497⭐] - 推送通知服务，由 [OneSignal](https://github.com/OneSignal) 开发。
...
* [Bloc](https://github.com/felangel/bloc) ⭐ 12,478 | 🐛 78 | 🌐 Dart | 📅 2026-09-17 \[8181⭐] - 一套帮助实现 BLoC 设计模式的包集合，由 [Felix Angelov](https://github.com/felangel) 开发。
* [GetX](https://github.com/jonataslaw/getx) ⭐ 11,198 | 🐛 1,185 | 🌐 Dart | 📅 2026-06-12 <!--jonataslaw/getx--> - 无需上下文的状态管理和导航，由 [Jonny Borges](https://github.com/jonataslaw) 开发。
* [RiverPod](https://github.com/rrousselGit/river_pod) ⭐ 7,387 | 🐛 158 | 🌐 Dart | 📅 2026-09-13 \[2214⭐] - Provider 的不同实现，由 [Remi Rousselet](https://github.com/rrousselGit) 开发。
* [Provider](https://github.com/rrousselGit/provider) ⭐ 5,252 | 🐛 38 | 🌐 Dart | 📅 2026-03-10 \[3974⭐] - Flutter 的状态管理库，由 [Remi Rousselet](https://github.com/rrousselGit) 开发。
* [MobX](https://github.com/mobxjs/mobx.dart) ⭐ 2,465 | 🐛 74 | 🌐 Dart | 📅 2026-09-14 \[2037⭐] - 使用透明功能响应式编程（TFRP）来增强应用程序中的状态管理。从 Js/React 领域移植的 MobX。
...
* [Graphql](https://github.com/zino-app/graphql-flutter) ⭐ 3,269 | 🐛 165 | 🌐 Dart | 📅 2026-07-28 \[2796⭐] - GraphQL 规范的实现，由 [Zino App B.V.](https://github.com/zino-app) 开发。
...
* [Dynamic Widget](https://github.com/dengyin2000/dynamic_widget) ⭐ 1,650 | 🐛 51 | 🌐 Dart | 📅 2025-06-25 \[1100⭐] - 使用 JSON 构建动态 UI，JSON 格式与 Flutter Widget 代码非常相似，由 [Denny Deng](https://github.com/dengyin2000) 开发。
...
* [NETCoreSync](https://github.com/aldycool/NETCoreSync) ⭐ 79 | 🐛 1 | 🌐 Dart | 📅 2022-12-08 - 面向多个客户端的集中式数据库同步框架，基于 [Moor](https://github.com/simolus3/moor) ⭐ 3,276 | 🐛 208 | 🌐 Dart | 📅 2026-09-16 库，由 [Aldy J](https://github.com/aldycool) 开发。
...
* [AnimatedTextKit](https://github.com/aagarwal1012/Animated-Text-Kit) ⭐ 1,775 | 🐛 84 | 🌐 Dart | 📅 2025-10-04 \[1268⭐] - 由 [Ayush Agarwal](https://github.com/aagarwal1012/) 开发的一组酷炫文本动画。
...
* [Drawing Animation](https://github.com/biocarl/drawing_animation) ⭐ 512 | 🐛 13 | 🌐 C++ | 📅 2025-08-22 \[384⭐] - 基于 SVG 路径数据创建绘制线条动画，由 [Carl Hauck](https://twitter.com/cahaucks) 开发。
...
* [Flame](https://github.com/luanpotter/flame) ⭐ 10,753 | 🐛 84 | 🌐 Dart | 📅 2026-09-14 \[5173⭐] - 极简主义的游戏引擎，由 [Luan Nico](https://github.com/luanpotter)提供。
...
* [Party Charades](https://github.com/vintage/party_flutter) ⭐ 211 | 🐛 0 | 🌐 Dart | 📅 2019-10-25 \[165⭐] - 派对字谜游戏，由 [Kamil Rykowski](https://github.com/vintage) 开发。
* [Slide Puzzle](https://github.com/kevmoo/slide_puzzle) ⭐ 179 | 🐛 0 | 🌐 Dart | 📅 2026-09-13 \[152⭐] - 经典的滑块（15）拼图游戏，由 [Kevin Moore](https://github.com/kevmoo) 开发。
...
* [AppFlowy](https://github.com/AppFlowy-IO/appflowy) ⭐ 76,788 | 🐛 1,034 | 🌐 Dart | 📅 2026-09-15 \[12156⭐] - 开源的 Notion 替代方案。你对数据和自定义有绝对控制。使用 Flutter 和 Rust 构建，由 [AppFlowy 团队](https://www.appflowy.io/) 开发。
...
* [Developer Quest](https://github.com/2d-inc/developer_quest) ⭐ 2,967 | 🐛 35 | 🌐 Dart | 📅 2021-05-05 \[2917⭐] - 成为技术领导者，消灭虫子，由 [2D, Inc](https://www.2dimensions.com/) 开发。

### Top

* [Flutter Common Widgets](https://github.com/alibaba/flutter-common-widgets-app) ⭐ 23,641 | 🐛 193 | 🌐 Dart | 📅 2023-12-11 \[22040⭐] - 收集中文官方小部件演示和文档，以帮助开发人员快速学习，由[Alibaba Auction Frontend Team](https://github.com/alibaba-paimai-frontend)。
* [Flutter Team Samples](https://github.com/flutter/samples) ⭐ 19,266 | 🐛 20 | 🌐 Dart | 📅 2026-09-14 \[8245⭐] - 示例集合（包括地图，json，Material和Cupertino） 由 [Flutter team](https://github.com/orgs/flutter/people)提供。
...
* [GitJournal](https://github.com/GitJournal/GitJournal) ⭐ 4,224 | 🐛 132 | 🌐 Dart | 📅 2026-05-26 \[507⭐] - 在Git Repo中记录数据，由[Vishesh Handa](https://github.com/vHanda)提供。
* [AuthPass](https://github.com/authpass/authpass) ⭐ 2,790 | 🐛 167 | 🌐 Dart | 📅 2026-09-15 \[372⭐] - 与手机和台式机兼容的Keepass密码管理器，由[hpoul](https://github.com/hpoul)提供。
...
* [Music Player](https://github.com/iampawan/Flutter-Music-Player) ⭐ 1,788 | 🐛 32 | 🌐 Dart | 📅 2024-01-15 \[1112⭐] - 全功能音乐播放器App，由[Pawan Kumar](https://about.me/imthepk)提供。
...
* [Taskist](https://github.com/huextrat/Taskist) ⭐ 1,057 | 🐛 9 | 🌐 Dart | 📅 2023-12-15 \[549⭐] - Taskist是任务管理的ToDo List App，由 [Hugo EXTRAT](https://github.com/huextrat)提供。
...
* [Reply](https://github.com/flschweiger/reply) ⭐ 553 | 🐛 5 | 🌐 Dart | 📅 2021-08-02 \[469⭐] - “答复”材料设计案例研究，由[Frederik Schweiger](https://github.com/flschweiger)提供。
...
* [Tourism](https://github.com/bluemix/tourism-demo) ⭐ 307 | 🐛 2 | 🌐 Dart | 📅 2018-10-25 \[213⭐] - 基于redux w / animations＆i18n的旅游应用程序，由 [blueMix](https://github.com/bluemix/tourism-demo) ⭐ 307 | 🐛 2 | 🌐 Dart | 📅 2018-10-25提供。
...
* [FVM](https://github.com/leoafarias/fvm) ⭐ 5,523 | 🐛 39 | 🌐 Dart | 📅 2026-09-11 \[2233⭐] - Flutter版本管理：一个简单的命令行工具，用于管理Flutter SDK的版本。
* [Very Good Cli](https://github.com/VeryGoodOpenSource/very_good_cli) ⭐ 2,419 | 🐛 11 | 🌐 Dart | 📅 2026-09-17 \[1135⭐] - Dart的非常好的命令行界面工具，由 [Very Good Ventures](https://github.com/VeryGoodOpenSource) 创建。
* [Launcher Icons](https://github.com/franzsilva/flutter_launcher_icons) ⭐ 2,119 | 🐛 144 | 🌐 Dart | 📅 2025-06-10 - 由 [Mark O'Sullivan](https://github.com/MarkOSullivan94) 和 [Franz Silva](https://github.com/franzsilva) 轻松生成应用程序的启动器图标。
...
* [FlutterGen](https://github.com/FlutterGen/flutter_gen) ⭐ 1,577 | 🐛 37 | 🌐 Dart | 📅 2026-09-15 \[791⭐] - 用于生成图像、字体、颜色等的资产代码的生成器，摆脱基于字符串的API。
...
* [Flutter Flavorizr](https://github.com/AngeloAvv/flutter_flavorizr) ⭐ 571 | 🐛 33 | 🌐 Dart | 📅 2026-09-16 \[160⭐] - CLI实用工具，可在不到3分钟的时间内轻松为Android和iOS生成不同的应用程序风格，由 [Angelo Cassano](https://github.com/AngeloAvv) 创建。
...
* [Environment Configuration](https://github.com/TatsuUkraine/dart_environment_config) ⭐ 91 | 🐛 4 | 🌐 Dart | 📅 2026-09-16 \[86⭐] - CLI工具，用于为应用程序环境生成`.env`配置文件，由 [TatsuUkraine](https://github.com/TatsuUkraine) 创建。
...
* [Fluent UI](https://github.com/bdlukaa/fluent_ui) ⭐ 3,469 | 🐛 44 | 🌐 Dart | 📅 2026-09-14 \[566⭐] - Microsoft的Fluent Design System在Flutter中的实现，由[Bruno D'Luka](https://twitter.com/bdlukaadev)开发。
...
* [Raspberry Pi Embedder](https://github.com/ardera/flutter-pi) ⭐ 1,994 | 🐛 126 | 🌐 C | 📅 2026-09-17 \[747⭐] - 适用于树莓派的轻量级嵌入器，由[Hannes Winkler](https://github.com/ardera)开发。
...
* [Native Shell](https://github.com/nativeshell/nativeshell) ⭐ 665 | 🐛 37 | 🌐 Rust | 📅 2025-04-21 \[372⭐] - Flutter的实验性嵌入器，由[Matej Knopp](https://twitter.com/matejknopp)开发。
* [Ubuntu Yaru](https://github.com/ubuntu/yaru.dart) ⭐ 394 | 🐛 58 | 🌐 Dart | 📅 2026-07-22 \[134⭐] - Ubuntu桌面的独特外观和风格，由[Ubuntu](https://github.com/ubuntu)开发。
